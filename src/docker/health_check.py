...
class DockerHealthCheck:
    ...
    def _check_filesystem_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            directories_to_check = [
                "/app",
                "/tmp", 
                "/app/pipeline-sessions" if Path("/app/pipeline-sessions").exists() else None
            ]
            ...
            for directory in directories_to_check:
                ...
                try:
                    ...
                    writable = dir_path.is_dir() and os.access(directory, os.W_OK) if exists else False
            ...
            if Path("/proc/meminfo").exists():
                ...
                for line in meminfo.split('\n'):
                    if line.startswith('MemTotal:'):
                        ...
                        memory_status["memory_info"]["available_mb"] = available_kb / 1024
                        
                        # Calculate memory usage percentage
                        if "total_mb" in memory_status["memory_info"]:
                            used_mb = memory_status["memory_info"]["total_mb"] - (available_kb / 1024)
                            usage_percent = (used_mb / memory_status["memory_info"]["total_mb"]) * 100
                            memory_status["memory_info"]["used_percent"] = round(usage_percent, 2)
                ...
                try:
                    ...
                    with open('/sys/fs/cgroup/memory/memory.limit_in_bytes', 'r') as f:
                        ...
                        if limit_bytes < 9223372036854771712:  # Not unlimited
                            memory_status["memory_info"]["container_limit_mb"] = limit_bytes / (1024 * 1024)
                            
                    with open('/sys/fs/cgroup/memory/memory.usage_in_bytes', 'r') as f:
                        usage_bytes = int(f.read().strip())
                        memory_status["memory_info"]["container_usage_mb"] = usage_bytes / (1024 * 1024)
                        
                        if "container_limit_mb" in memory_status["memory_info"]:
                            container_usage_percent = (usage_bytes / limit_bytes) * 100
                            memory_status["memory_info"]["container_usage_percent"] = round(container_usage_percent, 2)
        ...
        try:
            ...
            try:
                ...
                if hasattr(pipeline_server, 'server'):
                    ...
                    mcp_status["server_info"]["session_count"] = len(pipeline_server.sessions)
                    ...
                    if hasattr(pipeline_server, 'runtime_profiler'):
                        mcp_status["server_info"]["profiling_active"] = pipeline_server.runtime_profiler.is_profiling
                ...
                mcp_status["server_info"]["import_error"] = "Cannot import pipeline_server"
                mcp_status["status"] = "degraded"
            except Exception as e:
    ...
    def _generate_status_message(self, checks: Dict[str, Dict[str, Any]], overall_status: HealthStatus) -> str:
