...
class ClaudeCodeMCPBridge:
    ...
    def merge_claude_config(self, new_config: Dict[str, Any]) -> bool:
        ...
        if claude_config_path is None:
            ...
            claude_config_path = self.current_project / ".claude" / "claude_desktop_config.json"
    ...
    def create_project_mcp_config(self):
        ...
        project_config = {
            ...
            "servers": {
                "enabled": [],
                "available": ["mem0", "python-tools", "nodejs-tools", "universal"]
            },
    ...
    def setup_permissionless_integration(self) -> bool:
        ...
        try:
            ...
            if not self.mcp_system_dir.exists():
                ...
                print("    python3 install-mcp-system.py")
                return False
    ...
    def create_project_launchers(self):
        ...
        for launcher_name, description in launchers.items():
...
case "{launcher_name}" in
    "mcp")
        ...
        ;;
    "mcp-create")
        exec "$MCP_SYSTEM_DIR/components/mcp-create-server.py" "$@"
        ;;
    "mcp-test")
        exec "$MCP_SYSTEM_DIR/components/mcp-test-framework.py" "$@"
        ;;
    "mcp-upgrade")
...
'''
    ...
    def check_integration_status(self) -> Dict[str, Any]:
        ...
        launchers = ["mcp", "mcp-create", "mcp-test", "mcp-upgrade"]
    ...
    def auto_init_if_needed(self):
        ...
        if not status["mcp_system_installed"]:
            ...
            print("Run: python3 install-mcp-system.py")
            return False
