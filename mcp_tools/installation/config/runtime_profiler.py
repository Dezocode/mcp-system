                    ...
                    with open('/proc/meminfo', 'r') as f:
                        ...
                        for line in meminfo.split('\n'):
                            if line.startswith('MemTotal:'):
                                ...
                                health["system_memory_available_mb"] = available_kb / 1024
                                if 'system_memory_total_mb' in health:
                                    used_mb = health["system_memory_total_mb"] - (available_kb / 1024)
                                    health["system_memory_used_percent"] = (used_mb / health["system_memory_total_mb"]) * 100
