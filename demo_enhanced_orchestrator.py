...
def demo_service_discovery():
    ...
    if registry_path.exists():
        ...
        try:
            ...
            from mcp_service_registry import MCPServiceRegistry, ServiceType, ServiceCapability
...
def generate_demo_report():
    ...
    print(f"   Implementation rate: {len(existing_files)/len(implemented_files)*100:.1f}%")
