        ...
        for (
            ...
            if source.exists():
                ...
                if component.endswith(
                    (".sh", ".py")
                ) or not component.endswith((".md", ".json")):
                    dest.chmod(0o755)
                print(f"  ✅ {component}")
            else:
...
class MCPBridge:
    ...
    def create_project_launcher(self):
        ...
        launcher_content = (
            ...
            f"MCP_SYSTEM_DIR=\"{self.install_dir}\"\n"
            "PROJECT_ROOT=\"$(pwd)\"\n\n"
...
'''
    ...
    def create_claude_settings_integration(self):
        ...
        claude_settings = {
            "mcpServers": {
                "mcp-system": {
                    ...
                    "args": ["router"],
                    "env": {"MCP_SYSTEM_PATH": str(self.install_dir)},
                }
            },
            "mcp_system_integration": {
                "enabled": True,
        ...
        global_claude_config = (
            self.claude_settings_dir / "claude_desktop_config.json"
        )
        ...
        if global_claude_config.exists():
            ...
            try:
                ...
                existing_config["mcpServers"]["mcp-system"] = (
                    claude_settings["mcpServers"]["mcp-system"]
                )
                existing_config["mcp_system_integration"] = (
                    claude_settings["mcp_system_integration"]
                )
                ...
                print(
                    "  ⚠️  Existing Claude config invalid, creating new one"
                )
                with open(global_claude_config, "w") as f:
                    json.dump(
                        claude_settings,
