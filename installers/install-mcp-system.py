...
from test_surgical_protection import description
    ...
    def package_components(self):
        ...
        for (
            ...
            if source.exists():
                ...
                if component.endswith((".sh", ".py")) or not component.endswith(
                    (".md", ".json")
                ):
                    dest.chmod(0o755)
                print(f"  ✅ {component}")
    ...
    def create_claude_settings_integration(self):
        ...
        if global_claude_config.exists():
            ...
            try:
                ...
                existing_config["mcpServers"]["mcp-system"] = claude_settings[
                    "mcpServers"
                ]["mcp-system"]
                existing_config["mcp_system_integration"] = claude_settings[
                    "mcp_system_integration"
                ]
